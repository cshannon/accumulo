...
public class GetCompactionJobRequest {
  ...
  private TBaseJson<TInfo> tinfo;
  private TBaseJson<TCredentials> credentials;
  ...
  public GetCompactionJobRequest(TInfo tinfo, TCredentials credentials, String groupName,
    ...
    this.tinfo = new TBaseJson<>(tinfo);
    this.credentials = new TBaseJson<>(credentials);
    this.groupName = groupName;
    this.compactorAddress = compactorAddress;
    this.externalCompactionId = externalCompactionId;
  }

  public TBaseJson<TInfo> getTinfo() {
    return tinfo;
  }

  public void setTinfo(TBaseJson<TInfo> tinfo) {
    this.tinfo = tinfo;
  }

  public TBaseJson<TCredentials> getCredentials() {
    return credentials;
  }

  public void setCredentials(TBaseJson<TCredentials> credentials) {
